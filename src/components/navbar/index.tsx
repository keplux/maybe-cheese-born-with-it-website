        ...
        <>
          ...
          <div className='flex items-center justify-between sm:hidden bg-white border-y-2 border-black p-2'>
            ...
            <Disclosure.Button
              className={`${
                open ? 'bg-yellow-400' : ''
              } inline-flex items-center justify-center p-2 rounded-md text-black hover:text-yellow-800 hover:bg-yellow-400 focus:outline-none focus:ring-2 focus:ring-inset focus:ring-brand-500`}
            >
          ...
          <Disclosure.Panel className='sm:hidden bg-yellow-500'>
            <div className='pt-2 pb-3 space-y-1'>
              ...
              <Disclosure.Button
                as='a'
                href='#'
                className='bg-yellow-400 border-brand-500 text-brand-700 block pl-3 pr-4 py-2 border-l-4 text-base font-medium'
              >
                Home
              </Disclosure.Button>
              <Disclosure.Button
                as='a'
                href='#'
                className='border-transparent text-black hover:bg-yellow-300/30 hover:border-white hover:text-yellow-800 block pl-3 pr-4 py-2 border-l-4 text-base font-medium'
              >
                Menu
              </Disclosure.Button>
              <Disclosure.Button
